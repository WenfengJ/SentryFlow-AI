# Round 3: Solution Agent - 方向收敛与 24 小时方案

生成日期：2026-09-13  
阶段：Round 3 / Solution Agent  
目标：基于 Strategy Agent 和 Market Agent 的确定性结果，收敛项目方向，并设计 24 小时黑客松可落地方案。

## 1. 承接的前序判断

本轮不重新做市场调研，而是接收前两轮已经形成的共识：
...
| F-OPP-001 | 推荐方向应从“远程能源场站平台”调整为“小商业、仓库、轻工业和远程边缘资产的 eufy AI 安防交接 Agent”。 | 作为本轮主推荐方向。 |
...
| 基础 AI 识别已经成熟，不能作为差异化核心。 | Agent 定义从“识别 Agent”改成“交接 Agent”，重点是事件复核、风险解释、行动摘要。 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A. 小商业/仓库 AI 安防交接 Agent | 5 | 5 | 4 | 5 | 4 | 5 | 5 | 33 |
| B. 远程太阳能/储能资产守护 Agent | 4 | 4 | 5 | 4 | 5 | 3 | 4 | 29 |
| C. 家庭/小商业误报复核与每日摘要 Agent | 5 | 5 | 3 | 4 | 2 | 5 | 3 | 27 |
| D. 工厂/轻工业安全合规 Agent | 3 | 3 | 4 | 4 | 3 | 3 | 3 | 23 |
| E. 宠物/儿童/老人看护 Agent | 5 | 5 | 3 | 3 | 1 | 5 | 3 | 25 |

### 3.1 A. 小商业/仓库 AI 安防交接 Agent
...
- Agent 编排：不需要上复杂多 Agent 框架，MVP 用“事件分析器 + 摘要器 + 问答器”三个模块即可。

### 11.2 为什么不建议一上来用重 Agent 框架
...
| 编号 | 结论 | 状态 | 使用提醒 |
| --- | --- | --- | --- |
| F-SOL-001 | 主推荐方向是“面向小商业、仓库、轻工业和远程边缘资产的 eufy AI 安防交接 Agent”。 | confirmed-for-project | Round 4 可作为最终推荐方向。 |
| F-SOL-002 | 太阳能/储能场站不作为唯一主叙事，而作为高价值 Demo 样例或扩展场景。 | confirmed-for-project | 可用于路演中的差异化和马来西亚天气故事。 |
| F-SOL-003 | 项目差异化不是基础识别，而是轻量产品化的事件交接体验。 | confirmed-for-project | Pitch 中避免说“我们首创 AI 视频分析”。 |
| F-SOL-004 | 技术架构必须同时支持真实 SDK 接入和模拟事件流兜底。 | confirmed-for-project | 24 小时现场开发必须优先保证路径 B 可跑。 |
| F-SOL-005 | MVP 必做三类事件：后门夜间进入、摄像头遮挡/低光、暴雨后设备区可见性异常。 | likely | Round 4 可根据路演故事再微调。 |
| F-SOL-006 | Agent 产品定义应是“安防交接 Agent”，不是“视频识别 Agent”或“工业 CCTV 平台”。 | confirmed-for-project | 后续 README、Pitch、Demo 文案都应同步修正。 |

## 13. Solution Agent 结论

Round 3 推荐把项目从“远程能源场站 AI 巡检”收敛为：
